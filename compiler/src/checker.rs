...
impl TypeChecker {
    ...
    fn register_stdlib(&mut self) {
        ...
        let builtins: &[(&str, Vec<Type>, Type)] = &[
            ...
            // Maps (string → number)
            ("map_new", vec![], Map),
            ("map_set", vec![Map, String, Number], Number),
            ("map_get", vec![Map, String], Number),
            ("map_has", vec![Map, String], Number),
            ("map_len", vec![Map], Number),
            ("std_map_new", vec![], Map),
            ("std_map_set", vec![Map, String, Number], Number),
            ...
            ("std_ui_native_available", vec![], Number),
            ...
            ("ui_add_listbox", vec![], Number),
            ("std_ui_add_button", vec![String], Number),
            ("std_ui_add_edit", vec![String], Number),
            ("std_ui_add_listbox", vec![], Number),
            ("std_ui_window_show", vec![String, String], Number),
